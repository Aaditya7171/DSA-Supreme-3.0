...
int main() {
    ...
    // std::vector<std::vector<int>> arr(5, std::vector<int>(5,0));
    // int rowCount = arr.size();
    // int colSize = arr[0].size();
    
    // //jagged Array(2d array with different no. of columns in different rows)
    // std::vector<std::vector<int>> arr(5);
    // arr[0] = std::vector<int>(4);
    // arr[1] = std::vector<int>(3);
    // arr[2] = std::vector<int>(2);
    // arr[3] = std::vector<int>(5);
    // int rowSize = arr.size();
    // // int colSize = arr[i].size();
